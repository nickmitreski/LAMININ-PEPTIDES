-- Baseline: customers, order_references, product_mappings (see supabase/schema.sql).
-- Required before 20260402 / 20260403 migrations; some projects applied schema.sql
-- in the Dashboard only, so this was missing from migrations.
...
-- ============================================================================
-- 3. PRODUCT MAPPINGS TABLE (20260403_security_linter_hardening alters policies)
-- ============================================================================
...
-- Seed catalog (matches schema.sql; ON CONFLICT for idempotent re-runs)
